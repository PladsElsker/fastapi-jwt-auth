...
class LoadConfig(BaseModel):
    authjwt_token_location: Sequence[StrictStr] | None = {"headers"}
    ...
    authjwt_decode_leeway: Union[StrictInt, timedelta] | None = 0
    authjwt_encode_issuer: StrictStr | None = None
    authjwt_decode_issuer: StrictStr | None = None
    authjwt_decode_audience: Union[StrictStr, Sequence[StrictStr]] | None = None
    authjwt_denylist_enabled: StrictBool | None = False
    authjwt_denylist_token_checks: Sequence[StrictStr] | None = {"access", "refresh"}
    authjwt_header_name: StrictStr | None = "Authorization"
    authjwt_header_type: StrictStr | None = "Bearer"
    authjwt_access_token_expires: Union[StrictBool, StrictInt, timedelta] | None = (
        timedelta(minutes=15)
    )
    authjwt_refresh_token_expires: Union[StrictBool, StrictInt, timedelta] | None = (
        timedelta(days=30)
    )
    ...
    authjwt_csrf_methods: Sequence[StrictStr] | None = {
        "POST",
        "PUT",
        "PATCH",
        "DELETE",
